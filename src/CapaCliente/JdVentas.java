...
public class JdVentas extends javax.swing.JDialog {
    ...
    public JdVentas(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
        mostrarFechaLarga();
        listarClientes();
        ...
        hora();
        limpiarDatos();
        lblNumVenta.setText(String.valueOf(objVenta.generarCodigoVenta()));
        columnasTabla();
    }
    ...
    private void columnasTabla() {
        ...
        tblDetalle.getColumnModel().getColumn(2).setPreferredWidth(40);
        tblDetalle.getColumnModel().getColumn(3).setPreferredWidth(40);
    ...
    public void agregarProducto(int codigo, String nombre, String marca, double precio, int cantidad) {
        double subtotal = precio * cantidad;
        modelo.addRow(new Object[]{codigo, nombre, marca, precio, cantidad, subtotal});
        actualizarTotal();
    }
    ...
    private void Eliminar() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar este producto?", "Sistema", JOptionPane.YES_NO_OPTION);
        ...
        try {
            ...
            int cantidad = Integer.parseInt(modelo.getValueAt(fila, 4).toString());

            objProducto.Aumentar_DisminuirStock(cantidad, codigo, "AUMENTAR");
            modelo.removeRow(fila);
            actualizarTotal();
            JOptionPane.showMessageDialog(this, "Producto eliminado con éxito", "Sistema", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        lblNumVenta.setFont(new java.awt.Font("Verdana", 0, 15)); // NOI18N
        lblNumVenta.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(lblNumVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(75, 75, 75)
                                        .addComponent(jLabel7))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jLabel2)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cboClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblNumVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            objSeleccionar = new JdSeleccionarProductoVenta(parent, this);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (cboClientes.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un cliente", "Sistema", JOptionPane.INFORMATION_MESSAGE);
        } else if (cboTipoComprobante.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un tipo de comprobante", "Sistema", JOptionPane.INFORMATION_MESSAGE);
        } else if (tblDetalle.getRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "Debe ingresar productos al detalle", "Sistema", JOptionPane.INFORMATION_MESSAGE);
        } else {
